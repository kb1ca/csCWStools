...
public class AlterRetainedVersions {
	...
	public void alterRetainedVersions(Node thisNode, DocumentManagement docManClient) {
		// (we need to pull a more complete Node object to work with NodeVersionInfo - thisNode is the low calorie version)
		Node thisNodeWithMetadata = docManClient.getNode(thisNode.getID());

		// ... and is at default, then alter the maximum number of versions that will be retained by the node 
