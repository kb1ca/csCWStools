...
// follow a thread-safe Singleton pattern
public class SOAPServices {
	// this class stores a collection of references to Content Server CWS SOAP services
	
	// TODO need to add logic to refresh the authentication token from time to time (before it expires), but not with every request as it's an expensive operation
